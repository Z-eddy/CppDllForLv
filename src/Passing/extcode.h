...
static char rcsid_extcode[] = "$Id: //lvdist/releases/6.0/plat/win/cintools/extcode.h#2 $";
#endif
...
TH_REENTRANT MgErr		DSSetHandleSizeOrNewHandle(void *ph, int32);
TH_REENTRANT MgErr		DSSetHSzOrNewHClr(void *ph, int32);
